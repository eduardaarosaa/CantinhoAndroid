...
public class Constant {
    ...
    public static List<Publicacoes> getItemFavorites(Context ctx){
//        List<Publicacoes> items_all = getItemAll(ctx);
        List<Publicacoes> items_fav = new ArrayList<>();
//        List<String> items_id = FavoriteUtils.getFavorites(ctx);
